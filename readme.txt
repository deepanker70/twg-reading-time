...
1.  In your WordPress admin panel, go to "Settings" > "Reading Time".
...
* **Manual Display (Shortcode):** To display the reading time manually, use the `[twg_reading_time]` shortcode in your post content.
